...
categories: ''
---
Beginning from the winter vocation, I attend the **Mass Data Research Center in HIT** as a Research Assistant. In this research experience, I submitted a paper, as **first author**, proposing a reinforced framework for knowledge graph completion from reasoning perspective to **NeurIPS 2020 (awaiting decision)**.
